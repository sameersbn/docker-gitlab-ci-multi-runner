...
# digitallumberjack/gitlab-ci-multi-runner:1.10.2
...
```bash
docker pull digitallumberjack/gitlab-ci-multi-runner:1.10.2
```
...
docker run --name gitlab-ci-multi-runner -it --rm \
  --volume /srv/docker/gitlab-runner:/home/gitlab_ci_multi_runner/data \
  digitallumberjack/gitlab-ci-multi-runner:1.10.2 --help
```
